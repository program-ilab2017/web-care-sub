...
if($_SESSION['report_user']){
 ...
 $title="Number of KG established per CRP";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Number of KG established per CRP</small>
      </h1>
      <ol class="breadcrumb">
                    ...
                    <table class="table table-striped table-bordered" cellspacing="0" >
                      <thead>
                        <tr>
                          <th>Slno</th>                         
                          <th>Village Name</th>
                          <th>Number of KG established</th>
                      ...
                      <tbody>
                        <?php
                          ...
                          while($result_village=mysqli_fetch_assoc($sql_get_village)){
                            ...
                            $get_datas="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1' and `care_form_type`='2' and `care_CRP_employee_id`='$employee_id' ";
                ...
                <script type="text/javascript">
                 google.charts.load('current', {'packages':['bar']});
                  ...
                  function drawStuff() {
                       ...
                       ['village',  'KG established'],
                        ...
                        $get_village_sc="SELECT * FROM `care_master_village_info` ";
                          ...
                          while($result_village_sc=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sc="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1_sc' and `care_form_type`='2'  and `care_CRP_employee_id`='$employee_id' ";
                      ...
                      var options = {
                        title: 'Number of KG established <?=$total_count?>',
                        chartArea: {width: '80%'},
                         isStacked: true,
                        hAxis: {
