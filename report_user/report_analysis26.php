...
if($_SESSION['report_user']){
 ...
 $title="Number of cattle received vaccination per village per crp";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Number of cattle received vaccination per village per crp</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">New Report </a></li>
        <li class="active">Report/Analysis 26</li>
      </ol>
    </section>
                     ...
                     <table class="table table-striped table-bordered" cellspacing="0" >
                      <thead>
                        <tr>
                          ...
                          <th>Number of cattle received vaccination  </th>
                      ...
                      <tbody>
                        <?php
                          ...
                          while($result_village=mysqli_fetch_assoc($sql_get_village)){
                            ...
                            $get_datas="SELECT AVG(`care_LS_VN_no_of_animal`), Sum(`care_LS_VN_no_of_animal`),count(*) FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='2' AND `care_LS_month`='$months' AND `care_LS_year`='$Year' AND`care_LS_IP_vaccination` ='1' AND`care_LS_vlg_name`='$care_vlg_name1' and `care_LS_employee_id`='$employee_id'   ";
                ...
                <script type="text/javascript">
                 google.charts.load('current', {'packages':['bar']});
                  ...
                  function drawStuff() {
                       ...
                       ['village',  'Total vaccination '],
                        ...
                        $get_village_sc="SELECT * FROM `care_master_village_info` ";
                          ...
                          while($result_village_sc=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sc="SELECT AVG(`care_LS_VN_no_of_animal`), Sum(`care_LS_VN_no_of_animal`),count(*) FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='2' AND `care_LS_month`='$months' AND `care_LS_year`='$Year' AND`care_LS_IP_vaccination` ='1' AND`care_LS_vlg_name`='$care_vlg_name1_sc' and `care_LS_employee_id`='$employee_id'   ";
                      ...
                      var options = {
                        title: ' Number of cattle received vaccination ',
                        chartArea: {width: '80%'},
                         isStacked: true,
                        hAxis: {
                          title: 'vaccination ',
