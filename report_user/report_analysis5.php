                     ...
                     <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <?php
                              $get_data="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE`care_EV_month`='$months' AND `care_EV_year`='$Year' and `care_EV_them_intervention`='$care_thi_slno' and `care_EV_vlg_name`='$village' and `care_EV_employee_id`='$employee_id'";
