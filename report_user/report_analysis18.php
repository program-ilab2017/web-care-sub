...
if($_SESSION['report_user']){
 ...
 $title="Average production of vegetables per KG by CRP and villageP";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Average production of vegetables per KG by CRP and village</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">New Report </a></li>
        <li class="active">Report/Analysis 13</li>
      </ol>
    </section>
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          while($result_village=mysqli_fetch_assoc($sql_get_village)){
                            ...
                            $get_datas="SELECT AVG(`care_P_total_production`),sum(`care_P_total_production`) , count(*) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1' and `care_form_type`='2' and `care_CRP_employee_id`='$employee_id'";
                ...
                <script type="text/javascript">
                 google.charts.load('current', {'packages':['bar']});
                  ...
                  function drawStuff() {
                       ...
                       ['village',  'Area Of KG '],
                        ...
                        $get_village_sc="SELECT * FROM `care_master_village_info` ";
                          ...
                          while($result_village_sc=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sc="SELECT AVG(`care_P_total_production`),sum(`care_P_total_production`) , count(*) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1' and `care_form_type`='2' and `care_CRP_employee_id`='$employee_id'  ";
                      ...
                      var options = {
                        title: 'Average production KG <?=$avg?>',
                        chartArea: {width: '80%'},
                         isStacked: true,
                        hAxis: {
                          title: 'production KG ',
