                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                          $get_phl="SELECT * FROM `care_master_Post_Harvest_Loss` WHERE `care_PHL_hhid`='$care_hhi' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1'";
                  ...
                  <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php  $get_ph2="SELECT * FROM `care_master_Post_Harvest_Loss` WHERE `care_PHL_hhid`='$care_hhi' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1'";
                        ...
                        <tr>
                          ...
                          <input type="hidden" name="care_DP_male_present" value="1">
                          <input type="hidden" name="care_DP_female_present" value="1">
                        </tr>
                        <?php }?>
                      </tbody>
                    </table>
                   ...
                   <table id='example' class="table table-hover" border="1">
                      <thead>
                        <tr>
                          ...
                          <th>Comments Of CBO</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
                         $get_ph3="SELECT * FROM `care_master_Post_Harvest_Loss` WHERE `care_PHL_hhid`='$care_hhi' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1'";
                          ...
                          <td>
                            ...
                            if($fetch_table3['care_PHL_CBO_comment_status']=='0'){?>
                             <input  value="<?=web_encryptIt($fetch_table3['care_PHL_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$fetch_table3['care_PHL_CBO_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($fetch_table3['care_PHL_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$fetch_table3['care_PHL_CBO_comment_empty']?></textarea>
