                       ...
                       <tr>
                        <td><?=$shg_fetch['care_vlg_name']?></td>
                         ...
                         <td>MEO</td>
                          ...
                          ?>
                          <?=$res1['care_SHG_total_member_edit']?></td>
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td>MEO</td>
                          ...
                          <?php if($res2['care_SHG_RMU_cash_book_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td>CRP</td>
                         <td>
                             <?php if($res4['shg_field_new3']==1){echo "Yes";}?>
                             <?php if($res4['shg_field_new3']==2){echo "No";}?>
                          </td>
                          <td>
                             <?=$res4['shg_field_new4']?>
                          </td>                          
                           <td>
                            <?php if($res4['shg_field_new5']==1){echo "Yes";}?>
                             <?php if($res4['shg_field_new5']==2){echo "No";}?>
                          </td>
                           <td>
                             <?=$res4['shg_field_new6']?>
                          </td>
                          <td>
                            <?php if($res4['shg_field_new7']==1){echo "Yes";}?>
                             <?php if($res4['shg_field_new7']==2){echo "No";}?>
                          </td> 
                          <td>
                             <?=$res4['shg_field_new8']?>
                          </td>
                       ...
                       <tr>
                         ...
                         <td>MEO</td>
                          <?php if($res4['shg_field_new3_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                           <?php if($res4['shg_field_new3_edit']==1){echo "Yes";}?>
                           <?php if($res4['shg_field_new3_edit']==2){echo "No";}?>
                          
                          </td>
                          <?php if($res4['shg_field_new4_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                            <?=$res4['shg_field_new4_edit']?>
                          </td>                          
                           <?php if($res4['shg_field_new5_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                           <?php if($res4['shg_field_new5_edit']==1){echo "Yes";}?>
                           <?php if($res4['shg_field_new5_edit']==2){echo "No";}?>
                          </td>
                           <?php if($res4['shg_field_new6_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                            <?=$res4['shg_field_new6_edit']?>
                          </td>   
                           <?php if($res4['shg_field_new7_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                           <?php if($res4['shg_field_new7_edit']==1){echo "Yes";}?>
                           <?php if($res4['shg_field_new7_edit']==2){echo "No";}?>
                          </td>         
                           <?php if($res4['shg_field_new8_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td>CRP</td>
                          <td>
                            <?=$res5['care_SHG_no_of_mem_link_any_committee']?>
                          </td>
                          <td>
                            <?=$res5['care_SHG_committee_name']?>
                          </td>                          
                           <td>
                            <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting']==1){echo "Yes";}?>
                            <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting']==2){echo "No";}?>
                          </td>
                          <td><?=$res5['shg_field_new2']?></td>
                          <td>
                           <?php 
                            if($res5['care_SHG_mt_comment_status']=='0'){
                              echo "N/A";
                             }else{?>
                             <?=$res5['care_SHG_mt_comment_empty']?>
                            <?php }?>
                          </td>
                          ...
                          <td>
                           <?php 
                            if($res5['care_SHG_CBO_comment_status']=='0'){
                              ...
                              <?=$res5['care_SHG_CBO_comment_empty']?>
                            <?php }?>
                         </td>
                       ...
                       <tr>
                         ...
                         <td>MEO</td>
                          <?php if($res5['care_SHG_no_of_mem_link_any_committee_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                            <?=$res5['care_SHG_no_of_mem_link_any_committee_edit']?>
                          </td>
                          <?php if($res5['care_SHG_committee_name_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                            <?=$res5['care_SHG_committee_name_edit']?>
                          </td>                          
                           <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting_status']==2){?>
                              <td style=" border: 5px solid red;">
                            <?php }else{
                              ?>
                              <td>
                          ...
                          ?>
                           <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting_edit']==1){echo "Yes";}?>
                           <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting_edit']==2){echo "No";}?>
