                        ...
                        <tr>
                           ...
                           <td>
                            <select disabled class="form-control" name="Cash" required="">
                             <option value="1"  <?php if($res2['care_SHG_RMU_cash_book']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res2['care_SHG_RMU_cash_book']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td>
                            <select disabled class="form-control" name="Individual" required="">
                            <option value="1"  <?php if($res2['care_SHG_RMU_ind_passbook']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res2['care_SHG_RMU_ind_passbook']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td>
                            <select disabled class="form-control" name="Group" required="">
                             <option value="1"  <?php if($res2['care_SHG_RMU_group_passbook']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res2['care_SHG_RMU_group_passbook']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td>
