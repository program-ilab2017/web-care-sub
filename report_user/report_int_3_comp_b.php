...
<!-- =============================================== -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        No of HH trained on round the year homestead garden concept.
       <!--  <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li >Interventions # 3:</li>
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
           $get_detail="SELECT * FROM `care_master_mrf_exposure_visit_tarina_meo` WHERE `care_EV_them_intervention`='1' and `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year`='$Year'";
