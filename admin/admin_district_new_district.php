  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="admin_district_view_district.php"><i class="fa fa-map-marker"></i>Location Name</a></li>
        <li><a href="admin_district_view_district.php"><i class="fa fa-map-marker"></i>View District List</a></li>
          ...
          <div class="box box-primary">
            ...
            <div class="box-header ui-sortable-handle" style="cursor: move;">
              ...
              <div class="pull-right box-tools">
                <a href="admin_district_view_district.php" class="btn btn-info btn-sm" ><i class="fa fa-caret-square-o-left" aria-hidden="true"></i> Back </a>
              </div>
              <!-- /. tools -->
            </div>
          </div>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="admin_location_save_information.php" onsubmit="return check_districts();">
              <input type="hidden" name="form_type" value="<?=web_encryptIt('Admin Add District')?>">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-4 text-right" for="District_name">Name Of The District <span  style="color: red">*</span></label>
                    <div class="col-sm-8">
                      <input class="form-control" onkeyup="check_district(this)" id="District_name" placeholder="Enter District" name="District_name" type="District" required>
