        ...
        <div class="col-lg-10 col-md-offset-1">
          <div class="box box-primary">
            ...
            <form role="form" method="POST" action="admin_general_setting_save_information.php" onsubmit="return check_districts();">
              <input type="hidden" name="form_type" value="<?=web_encryptIt('Admin Add Thematic')?>">
              <input type="hidden" name="web_district" id="web_group" value="<?=web_encryptIt('Thematic_information')?>">
              <div class="box-body">
            ...
            $.ajax({
                ...
                success:function(html){                 
                    if(html==1){
                        ...
                        document.getElementById("error").innerHTML = "Group Record Is In our Record  ,"+group_location;
