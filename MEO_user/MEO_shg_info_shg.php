...
if($_POST['form_type']){
  ...
  if($form_type=='get_hhi_infomation'){
    ...
    $employee_id=$_POST['employee_id'];
      ...
      $get_detail_query41="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1'";
 ...
 header('Location:MEO_shglist_info_shglist.php');
 exit; 
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_detail_query="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1'";
                       ...
                       <tr>
                          <td><?=$res1['care_SHG_date']?></td>
                          <td><?=$res1['care_SHG_name']?></td>
                          <td><input value="<?=$res1['care_SHG_total_member']?>" class="form-control" type="number" min="0" name="care_SHG_total_member[]" required=""></td>
                          <td><input value="<?=$res1['care_SHG_LMM_date']?>" class="form-control" type="text" name="care_SHG_LMM_date[]" id="datepicker" required=""></td>
                          <td><input value="<?=$res1['care_SHG_mem_prsnt_monthly_meeting']?>" class="form-control" type="text" name="care_SHG_mem_prsnt_monthly_meeting[]" required=""></td>
                  ...
                  <div id="part2" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php 
                          $get_detail_query1="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1'";
                        ...
                        <tr>
                           ...
                           <td>
                            <select  class="form-control" name="care_SHG_RMU_saving_loan_ledger_book[]"  disabled required="">
                          ...
                          <tr>
                           <td>
                            <select  class="form-control" name="care_SHG_RMU_meeting_redg[]" required="">
                             <option value="1"  <?php if($res2['care_SHG_RMU_meeting_redg']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res2['care_SHG_RMU_meeting_redg']==2){echo "selected";}?>>No</option>
                          </td>
                    
                           <td>
                            <select  class="form-control" name="care_SHG_RMU_saving_loan_ledger_book[]" required="">
                             <option value="1"  <?php if($res2['care_SHG_RMU_saving_loan_ledger_book']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res2['care_SHG_RMU_saving_loan_ledger_book']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                           <?php 
                        $get_detail_query2="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1'";
                        $sql_exe_deatils2=mysqli_query($conn,$get_detail_query2);
                        while ($res3=mysqli_fetch_assoc($sql_exe_deatils2)) {?>
                        <tr>
                          <td>
                            <select disabled class="form-control" name="care_SHG_ML_linkage_external_credit[]" required="">
                             <option value="1"  <?php if($res3['care_SHG_ML_linkage_external_credit']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res3['care_SHG_ML_linkage_external_credit']==2){echo "selected";}?>>No</option>
                          </select>
                        ...
                        <tr>
                          <td>
                            <select  class="form-control" name="care_SHG_ML_linkage_external_credit[]" required="">
                             <option value="1"  <?php if($res3['care_SHG_ML_linkage_external_credit']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res3['care_SHG_ML_linkage_external_credit']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td>
                            <input  value="<?=$res3['care_SHG_ML_bank_name']?>" type="text" class="form-control" name="care_SHG_ML_bank_name[]" required="">
                          </td>
                           <td>
                            <input  value="<?=$res3['care_SHG_ML_no_of_mem_link_market']?>" type="number" min="0" class="form-control" name="care_SHG_ML_no_of_mem_link_market[]" required="">
                          </td>
                           <td>
                            <input  value="<?=$res3['care_SHG_ML_no_of_mem_link_tech_support_provider']?>" type="number" min="0" class="form-control" name="care_SHG_ML_no_of_mem_link_tech_support_provider[]" required="">
                          </td>
                           <td>
                            <input type="text" value="<?=$res3['shg_field_new1']?>" class="form-control" name="shg_field_new1[]" required="">
                          </td>
                        </tr>
                        <?php }?>
                      </tbody>
                  ...
                  <div id="part4" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                        $get_detail_query3="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1'";
                        $sql_exe_deatils3=mysqli_query($conn,$get_detail_query3);
                        while ($res4=mysqli_fetch_assoc($sql_exe_deatils3)) {?>
                        <tr>
                          <td>
                          <select class="form-control" name="shg_field_new3[]" disabled required="">
                            <option value="1"  <?php if($res4['shg_field_new3']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res4['shg_field_new3']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td>
                            <input type="text" value="<?php echo $res4['shg_field_new4']?>" disabled class="form-control" name="shg_field_new4[]">
                          </td>
                          <td>
                            <select class="form-control" name="shg_field_new5[]" disabled required="">
                            <option value="1"  <?php if($res4['shg_field_new5']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res4['shg_field_new5']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td>                  
                          <input type="text" class="form-control" disabled value="<?php echo $res4['shg_field_new6']?>" name="shg_field_new6[]" required="">
                          </td>
                           <td>
                           <select class="form-control" name="shg_field_new7[]" disabled required="">
                            <option value="1" <?php if($res4['shg_field_new7']==1){echo "selected";}  ?>>Yes</option>
                            <option value="2" <?php if ($res4['shg_field_new7']==2){echo "selected";}?>>No</option>
                           </select>
                          </td>
                           <td>
                            <input type="text" disabled class="form-control" value="<?php echo $res4['shg_field_new8']?>" name="shg_field_new8[]" required="">
                          </td>
                        
                        </tr>
                         <tr>
                          <td>
                          <select class="form-control" name="shg_field_new3[]"  required="">
                            <option value="1"  <?php if($res4['shg_field_new3']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res4['shg_field_new3']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td>
                            <input type="text" value="<?php echo $res4['shg_field_new4']?>"  class="form-control" name="shg_field_new4[]">
                          </td>
                          <td>
                            <select class="form-control" name="shg_field_new5[]"  required="">
                            <option value="1"  <?php if($res4['shg_field_new5']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res4['shg_field_new5']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td>
                            <input type="text" class="form-control"  value="<?php echo $res4['shg_field_new6']?>" name="shg_field_new6[]" required="">
                          </td>
                           <td>
                           <select class="form-control" name="shg_field_new7[]"  required="">
                            <option value="1" <?php if($res4['shg_field_new7']==1){echo "selected";}  ?>>Yes</option>
                            <option value="2" <?php if ($res4['shg_field_new7']==2){echo "selected";}?>>No</option>
                           </select>
                          </td>
                           <td>
                            <input type="text"  class="form-control" value="<?php echo $res4['shg_field_new8']?>" name="shg_field_new8[]" required="">
                          </td>
                  ...
                  <div id="part5" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                      <?php 
                        $get_detail_query4="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_MEO_status`='0' and `care_SHG_CBO_comment_status`='1'";
                        $sql_exe_deatils4=mysqli_query($conn,$get_detail_query4);
                        while ($res5=mysqli_fetch_assoc($sql_exe_deatils4)) {?>
                        <tr>
                          <td>
                            <input disabled type="number" value="<?=$res5['care_SHG_no_of_mem_link_any_committee']?>" min="1" class="form-control" name="Consumption[]" required="">
                          </td>
                          <td>
                            <input disabled type="text" value="<?=$res5['care_SHG_committee_name']?>" class="form-control" name="Sale[]" required="">
                          </td>                          
                          <td>
                            <select disabled class="form-control" name="type_input_training[]" required="">
                            <option value="1"  <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td> <textarea disabled class="form-control" name="shg_field_new2[]" required=""><?=$res5['shg_field_new2']?></textarea></td>

                          <td>
                           <?php 
                            if($res5['care_SHG_mt_comment_status']=='0'){
                              echo "N/A";
                             }else{?>
                             
                              <textarea readonly=""  type="text" class="form-control" ><?=$res5['care_SHG_mt_comment_empty']?></textarea>
                          ...
                          <td>
                           <?php 
                            if($res5['care_SHG_CBO_comment_status']=='0'){?>
                             <input  value="<?=web_encryptIt($res5['care_SHG_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$res5['care_SHG_CBO_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($res5['care_SHG_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$res5['care_SHG_CBO_comment_empty']?></textarea>
                       ...
                       <tr>
                          <td>
                            <input type="number" value="<?=$res5['care_SHG_no_of_mem_link_any_committee']?>" min="1" class="form-control" name="care_SHG_no_of_mem_link_any_committee[]" required="">
                          </td>
                          <td>
                            <input type="text" value="<?=$res5['care_SHG_committee_name']?>" class="form-control" name="care_SHG_committee_name[]" required="">
                          </td>                          
                           <td>
                            <select class="form-control" name="care_SHG_nutrition_discus_SHG_mnthly_meeting[]" required="">
                            <option value="1"  <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res5['care_SHG_nutrition_discus_SHG_mnthly_meeting']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td><textarea  class="form-control" name="shg_field_new2[]" required=""><?=$res5['shg_field_new2']?></textarea></td>
                          <td>
                           <?php 
                            if($res5['care_SHG_mt_comment_status']=='0'){
                              echo "N/A";
                              ...
                              <textarea readonly="" name="care_SHG_mt_comment_empty[]"  type="text" class="form-control" ><?=$res5['care_SHG_mt_comment_empty']?></textarea>
                          ...
                          <td>
                           <?php
                            ...
                            echo "N/A";
                              ...
                              <textarea readonly=""  type="text" class="form-control"><?=$res5['care_SHG_CBO_comment_empty']?></textarea>
