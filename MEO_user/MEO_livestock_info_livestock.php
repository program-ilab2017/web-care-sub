                ...
                <div class="tab-content">
                  <div id="part1" class="setup-content tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1" >
                      ...
                      <tbody>
                        <?php 
                        $get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='0' ";
                  ...
                  <div id="part2" class="tab-pane fade">
                     <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           $get_life_stoc="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='0'";
                        ...
                        <td>
                         ...
                         <td><select  class="form-control" name="care_LS_cultivating_fodder[]" required="">
                          ...
                          <td><input class="form-control"  value="<?=$fetch_table2['care_LS_cultivated_area']?>"  type="text" name="care_LS_cultivated_area[]" required=""></td>
                          <td><select  class="form-control" name="care_LS_new_farmer[]" required="">
                             <option value="1"  <?php if($fetch_table2['care_LS_new_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table2['care_LS_new_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td><select  class="form-control" name="care_LS_continued_farmer[]" required="">
                             <option value="1"  <?php if($fetch_table2['care_LS_continued_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table2['care_LS_continued_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>                  
                        </tr>
                  ...
                  <div id="part3" class="tab-pane fade">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_life_stock3="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='0'";
