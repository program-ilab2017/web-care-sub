              ...
              <div class="table-responsive">
                  ...
                  <thead>
                    ...
                    <tbody>
                      ...
                      $x=0;
                      if($form_type=='get_hhi_infomation'){
                       $GET_INFO="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `care_villege_name`='$village' AND `date`BETWEEN '$date_one' AND '$date_two'";
                      }
                    ...
                    ?>
                     <tr>
                      ...
                      <td><?=strtolower($res['care_MEO_id'])?></td>
                      <td><?=$res['date']?></td>
                      <td>
                          <div class="btn-group">
                              ...
                              <ul class="dropdown-menu">
                               <li><a href="MEO_NGTKO_instruction_view.php?slno=<?php echo $res['slno']?>" target="_blank">View Details</a></li>
                            </ul>
                        </div>
                      </td>
                  </tr>
