                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    ...
                    <table id='example11' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                          $form_lst1="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina_meo` WHERE `care_MTF_hhid`='$care_hhi' and `care_MTF_month`='$months' and `care_MTF_year`='$year' and `care_MTF_vlg_name`='$village' and `care_MTF_mt_comment_status`='1' and `care_MTF_CBO_comment_status`='1' and `care_MTF_MEO_status`='1'";
                  ...
                  <table id='example12' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                          $sql_id_query="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina_meo` WHERE `care_MTF_hhid`='$care_hhi' and `care_MTF_month`='$months' and `care_MTF_year`='$year' and `care_MTF_vlg_name`='$village' and `care_MTF_mt_comment_status`='1' and `care_MTF_CBO_comment_status`='1' and `care_MTF_MEO_status`='1'";
                  ...
                  <div id="part3" class="tab-pane fade">
                   ...
                   <table id='example13' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php
                          $sql_id_query1="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina_meo` WHERE `care_MTF_hhid`='$care_hhi' and `care_MTF_month`='$months' and `care_MTF_year`='$year' and `care_MTF_vlg_name`='$village' and `care_MTF_mt_comment_status`='1' and `care_MTF_CBO_comment_status`='1' and `care_MTF_MEO_status`='1'";
