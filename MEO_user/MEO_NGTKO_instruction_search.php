              ...
              <div class="table-responsive">
                  ...
                  <thead>
                    ...
                    <tbody>
                      ...
                      $x=0;
                      if($form_type=='get_hhi_infomation'){
                       $GET_INFO="SELECT * FROM `care_master_mt_NGTKO_instruction_form` WHERE `care_villege_name`='$village' AND `care_MEO_status`='1' AND `date`BETWEEN '$date_one' AND '$date_two'";
                      }
