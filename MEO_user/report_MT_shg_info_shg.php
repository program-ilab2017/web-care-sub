                ...
                <div class="tab-content">
                  ...
                  <!--  <li class="next pull-right" ><input type="submit" name="save" value="save"></li> -->
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                       <?php 
                        $get_detail_query5="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year'";
