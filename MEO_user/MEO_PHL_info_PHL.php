                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                          $get_phl="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_hhid`='$care_hhi' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1'and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='0'";
                          $sql_phl_table1=mysqli_query($conn,$get_phl);
                          while ($fetch_table1=mysqli_fetch_assoc($sql_phl_table1)) {
                           
                        ?>
                        <tr>
                          <input  value="<?=web_encryptIt($fetch_table1['care_PHL_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                          <td>CRP Input</td>
                          ...
                          <td><input disabled value="<?=$fetch_table1['care_CT_male_present']?>" class="form-control" type="number" min="0" name="classroom_male" required=""></td>
                          <td><input disabled value="<?=$fetch_table1['care_CT_feamle_present']?>" class="form-control" type="number" min="0" name="classroom_female" required=""></td>
                        </tr>

                         <tr>
                            <td>MEO Input</td>
                          <td><input disabled value="<?=$fetch_table1['care_PHL_date']?>" class="form-control"  required=""></td>
                          <td><select  class="form-control" name="care_CT_status[]" required="">
                            <option value="1"  <?php if($fetch_table1['care_CT_status']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table1['care_CT_status']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td><select class="form-control" name="care_CT_subject_matter[]" required="">
                            <option value="1" <?php if($fetch_table1['care_CT_subject_matter']==1){echo "selected";}?>> Improved Storing</option>
                            <option value="2" <?php if($fetch_table1['care_CT_subject_matter']==2){echo "selected";}?>>  FAQ & others on Pulse,Veg/Fruits/Grains</option>
                          </select></td>
                          <td><input value="<?=$fetch_table1['care_CT_male_present']?>" class="form-control" type="number" min="0" name="care_CT_male_present[]" required=""></td>
                          <td><input value="<?=$fetch_table1['care_CT_feamle_present']?>" class="form-control" type="number" min="0" name="care_CT_feamle_present[]" required=""></td>
                        </tr> 
                        <?php }?>
                      </tbody>
                    </table>
                  ...
                  <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php  $get_ph2="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_hhid`='$care_hhi' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1' and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='0'";
                        ...
                        <tr>
                          ...
                          <!-- <td><input disabled value="<?=$fetch_table2['care_DP_male_present']?>" class="form-control" type="number" name="Demonstration_male" required=""></td>
                          <td><input disabled value="<?=$fetch_table2['care_DP_female_present']?>" class="form-control" type="number" name="Demonstration_female" required=""></td>  --> 
                        </tr>
                        <tr>
                          <td><select  class="form-control" name="care_DP_status[]" required="">
                             <option value="1"  <?php if($fetch_table2['care_DP_status']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table2['care_DP_status']==2){echo "selected";}?>>No</option>
                            </select></td>
                          
                          <td><select  class="form-control" name="care_DP_subject_matter[]" required="">
                             <option value="1" <?php if($fetch_table2['care_DP_subject_matter']==1){echo "selected";}?>> Improved Storing</option>
                             <option value="2" <?php if($fetch_table2['care_DP_subject_matter']==2){echo "selected";}?>>  FAQ & others on Pulse,Veg/Fruits/Grains</option>
                             </select></td>

                            <input type="hidden" name="care_DP_male_present[i]" value="1">
                            <input type="hidden" name="care_DP_female_present[i]" value="1">
                  ...
                  <div id="part3" class="tab-pane fade">
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_ph3="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_hhid`='$care_hhi' and `care_PHL_month`='$months' and `care_PHL_year`='$year' and `care_PHL_villege_name`='$village' and `care_PHL_mt_comment_status`='1' and `care_PHL_CBO_comment_status`='1' and `care_PHL_MEO_status`='0'";
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            if($fetch_table3['care_PHL_mt_comment_status']=='0'){
                              ...
                              <textarea readonly=""  type="text" class="form-control"><?=$fetch_table3['care_PHL_mt_comment_empty']?></textarea>
                          ...
                          <td>
                            ...
                            echo "N/A";  
                              ...
                              <textarea readonly=""  type="text" class="form-control" ><?=$fetch_table3['care_PHL_CBO_comment_empty']?></textarea>
                        ...
                        <tr>
                          <td><select  class="form-control" name="care_IP_name[]" required="">
                            <option value="">--Please Select--</option>
                            <option value="1" <?php if($fetch_table3['care_IP_name']==1){echo "selected";}?>> Moistermeter</option>
                            <option value="2" <?php if($fetch_table3['care_IP_name']==2){echo "selected";}?>>  Hermative bags</option>
                            <option value="3" <?php if($fetch_table3['care_IP_name']==3){echo "selected";}?>>  Tarpaulin sheet</option>
                           ...
                           <td><select  class="form-control" name="care_implements[]" required="">
                            <option value="1" <?php if($fetch_table3['care_implements']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_implements']==2){echo "selected";}?>>No</option>
                          </select></td>
                           <td><select  class="form-control" name="care_farmer_parcticing[]" required="">
                            <option value="1" <?php if($fetch_table3['care_farmer_parcticing']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_farmer_parcticing']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td>
