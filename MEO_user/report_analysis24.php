...
if($_SESSION['meo_user']){
 ...
 $title="Average quantity of production of pulses in non-demo plot";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Average quantity of production of pulses in non-demo plot</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">New Report </a></li>
        <li class="active">Report/Analysis 24</li>
      </ol>
    </section>
                        ...
                        <?php
                          ...
                          while($result_village=mysqli_fetch_assoc($sql_get_village)){
                            $care_vlg_name1=$result_village['care_vlg_name'];
                             $get_datas="SELECT AVG(`care_P_total_production`), Sum(`care_P_total_production`),count(*) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1' and `care_form_type`='1' and `care_demo_plot_farmer`='2' ";
                       ...
                       ['village',  'Total production '],
                        ...
                        $get_village_sc="SELECT * FROM `care_master_village_info` WHERE `care_vlg_district`='$location_user'";
                          ...
                          while($result_village_sc=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sc="SELECT AVG(`care_P_total_production`), Sum(`care_P_total_production`),count(*)  FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1_sc'  and `care_form_type`='1' and `care_demo_plot_farmer`='2'  ";
