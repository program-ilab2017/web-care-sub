			...
			case 'form7':
				...
				if(!empty($care_continued_farmer)){
					for ($i=0; $i <count($slno) ; $i++) {
						...
						$update_crp="UPDATE `care_master_crop_diversification_crp` SET `care_crop_div_MEO_status`, `care_crop_div_MEO_time`, `care_crop_div_MEO_date`, `care_crop_div_MEO_id` WHERE `care_slno`='$slno_single'";
						...
						if($sql_update_crp){
							...
							$insert="INSERT INTO `care_master_crop_diversification_crp_meo`( `care_crop_serial_id`, `care_hhid`, `care_women_farmer`, `care_spouse_name`, `care_pulses_type`, `care_area_cultivated`, `care_continued_farmer`, `care_demo_plot_farmer`, `care_new_farmer`, `care_IR_training`, `care_IR_seed`, `care_IR_fertiliser`, `care_IR_pesticides`, `care_IR_extension_support`, `care_IR_other`, `care_CRP_other_detail`, `care_QR_seed`, `care_QR_fertiliser`, `care_QR_pesticides`, `care_QR_other`, `care_P_consumption`, `care_P_sale`, `care_P_total_production`, `care_avg_price`, `care_form_type`, `care_type_farm`, `care_CRP_lat_id`, `care_CRP_long_id`, `care_CRP_employee_id`, `care_CRP_vlg_name`, `care_CRP_gp_name`, `care_CRP_block_name_`, `care_CRP_district_name`, `care_CRP_month`, `care_CRP_year`, `care_CRP_status`, `care_CRP_date`, `care_CRP_time`, `care_crop_div_comment_mt`, `care_crop_div_date_comment`, `care_crop_div_time_comment_mt`, `care_crop_div_mt_id`, `care_crop_div_mt_id_status`) SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_slno`='$slno_single'";
							$sql_insert_crp=mysqli_query($conn,$insert);
							if($sql_insert_crp){
								$update_meo="UPDATE `care_master_crop_diversification_crp_meo` SET `care_area_cultivated_edit`=[value-47],`care_area_cultivated_status`=[value-48],`care_continued_farmer_edit`=[value-49],`care_continued_farmer_status`=[value-50],`care_demo_plot_farmer_edit`=[value-51],`care_demo_plot_farmer_status`=[value-52],`care_new_farmer_edit`=[value-53],`care_new_farmer_status`=[value-54],`care_IR_TRAINING_edit`=[value-55],`care_IR_TRAINING_status`=[value-56],`care_IR_seed_edit`=[value-57],`care_IR_seed_status`=[value-58],`care_IR_fertiliser_edit`=[value-59],`care_IR_fertiliser_status`=[value-60],`care_IR_pestisides_edit`=[value-61],`care_IR_pestisides_status`=[value-62],`care_IR_extension_support_edit`=[value-63],`care_IR_extension_support_status`=[value-64],`care_IR_other_edit`=[value-65],`care_IR_other_status`=[value-66],`care_CRP_other_details_edit`=[value-67],`care_CRP_other_details_status`=[value-68],`care_QR_seed_edit`=[value-69],`care_QR_seed_status`=[value-70],`care_QR_fertiliser_edit`=[value-71],`care_QR_fertiliser_status`=[value-72],`care_QR_pesticides_edit`=[value-73],`care_QR_pesticides_status`=[value-74],`care_QR_other_edit`=[value-75],`care_QR_other_status`=[value-76],`care_P_consumption_edit`=[value-77],`care_P_consumption_status`=[value-78],`care_P_sale_edit`=[value-79],`care_P_sale_status`=[value-80],`care_P_total_production_edit`=[value-81],`care_P_total_production_status`=[value-82],`care_avg_price_edit`=[value-83],`care_avg_price_status`=[value-84],`care_form_type_edit`=[value-85],`care_form_type_status`=[value-86],`care_type_farm_edit`=[value-87],`care_type_farm_status`=[value-88],`care_CRP_lat_id_edit`=[value-89],`care_CRP_lat_id_status`=[value-90],`care_CRP_long_id_edit`=[value-91],`care_CRP_long_id_status`=[value-92],`care_CRP_employee_id_edit`=[value-93],`care_CRP_employee_id_status`=[value-94],`care_CRP_vlg_name_edit`=[value-95],`care_CRP_vlg_name_status`=[value-96],`care_CRP_gp_name_edit`=[value-97],`care_CRP_gp_name_status`=[value-98],`care_CRP_block_name_edit`=[value-99],`care_CRP_block_name_status`=[value-100],`care_CRP_district_name_edit`=[value-101],`care_CRP_district_name_status`=[value-102],`care_CRP_month_edit`=[value-103],`care_CRP_month_status`=[value-104],`care_CRP_year_edit`=[value-105],`care_CRP_year_status`=[value-106],`care_CRP_status_edit`=[value-107],`care_CRP_date_edit`=[value-108],`care_CRP_time_edit`=[value-109] WHERE `care_crop_serial_id`='$slno_single'";
