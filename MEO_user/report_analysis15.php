...
if($_SESSION['meo_user']){
 ...
 $title="Number of KG established  per village";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Number of KG established per village</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">New Report </a></li>
        <li class="active">Report/Analysis 15</li>
      </ol>
    </section>
                      ...
                      <tbody>
                        <?php
                          ...
                          while($result_village=mysqli_fetch_assoc($sql_get_village)){
                            ...
                            $get_datas="SELECT AVG(`care_area_cultivated`), Sum(`care_area_cultivated`),count(*) FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1' and `care_form_type`='2' ";
                ...
                <script type="text/javascript">
                 google.charts.load('current', {'packages':['bar']});
                  ...
                  function drawStuff() {
                       ...
                       ['village',  'Area Of KG '],
                        ...
                        $get_village_sc="SELECT * FROM `care_master_village_info` WHERE `care_vlg_district`='$location_user' ";
                          ...
                          while($result_village_sc=mysqli_fetch_assoc($sql_get_village_sc)){
                            ...
                            $get_datas_sc="SELECT AVG(`care_area_cultivated`), Sum(`care_area_cultivated`),count(*)  FROM `care_master_crop_diversification_crp` WHERE `care_CRP_month`='$months' and `care_CRP_year`='$Year' and `care_CRP_vlg_name`='$care_vlg_name1_sc' and `care_form_type`='2'  ";
                      ...
                      var options = {
                        title: 'Average size of the KG <?=$avg?>',
                        chartArea: {width: '80%'},
                         isStacked: true,
                        hAxis: {
