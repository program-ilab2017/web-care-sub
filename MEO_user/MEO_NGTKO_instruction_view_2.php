...
require 'FlashMessages.php';
 ...
 $check_query="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `slno`='$slno'";
          ...
          <div class="panel-body">
            <div class="row">        
              ...
              <div class="col-xs-12">
                <div class="col-xs-6">
                  <?php 
                    $get_detail_query="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `slno`='$slno'";
                ...
                <div class="tab-content">
                   <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php 
                        echo $get_group_query="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `slno`='$slno'";
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                               $care_slno=$sql_exe_group_check['care_farmer_field_group'];
                 ...
                 <div id="part2" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <?php 
                        echo $get_number_query="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `slno`='$slno'";
                 ...
                 <br>
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                      <?php 
                        echo $get_ngtk_query="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `slno`='$slno'";
                  ...
                  <div id="part4" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                        echo $get_observe_query="SELECT * FROM `care_master_mt_NGTKO_instruction_form_meo` WHERE `slno`='$slno'";
