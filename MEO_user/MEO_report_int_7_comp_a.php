...
<!-- =============================================== -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       No of training and capacity building programme provided to the collectives.
       <!--  <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li >Interventions # 7:</li>
         <li class="active">Components A: </li>
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
           $get_detail="SELECT * FROM `care_master_MRF_exposure_visit_TARINA_meo` WHERE `care_EV_them_intervention`='8' and `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year`='$Year'";
                    ...
                    <tfoot>
                     ...
                     <tbody>
                      ...
                      <tr>
                        ...
                        <td><?=$sql_get_detail_fetch['care_EV_male_Participants_edit']?></td>
                        <td><?=$sql_get_detail_fetch['care_EV_female_Participants_edit']?></td>
                      </tr>
                   <?php }?>
                  </tbody>
                 </tbody>
