                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                            $get_kictch1="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_hhid`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='0'";
                        ...
                        <tr>
                         <td> <?=$res_fetch['care_CRP_date']?></td>
                          <td><select class="form-control" name="care_pulses_type[]"  required="">
                               <?php 
                                ...
                                while ($training_fetch=mysqli_fetch_assoc($sql_exe_training)) {
                                  ?>
                                   <option value="<?=$training_fetch['item_crop']?>" <?php if($res_fetch['care_pulses_type']==$training_fetch['item_crop']){ echo "selected"; }?>><?=$training_fetch['item_crop']?></option>
                            ...
                            <!-- <input class="form-control" type="text" name="care_pulses_type[]" value="<?=$res_fetch['care_pulses_type']?>" required=""></td> -->
                          <td><input class="form-control" type="text" name="care_area_cultivated[]" value="<?=$res_fetch['care_area_cultivated']?>" required=""></td>
                          <td><select class="form-control" name="care_new_farmer[]" required="">
                            <option value="1"  <?php if($res_fetch['care_new_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res_fetch['care_new_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>
                          ...
                          <td><select class="form-control" name="care_continued_farmer[]" required="">
                            <option value="1"  <?php if($res_fetch['care_continued_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res_fetch['care_continued_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>
                        </tr>
                  ...
                  <div id="part2" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php
                          $get_kictch2="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_hhid`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='0'";
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                       <?php
                          $get_kictch3="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_hhid`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='0'";
                        ...
                        <tr>
                          ...
                          <tr>
                          <td>
                            <input type="number" min="0" class="form-control" value="<?=$res_fetch3['care_QR_seed']?>"  name="care_QR_seed[]" required="">
                          </td>
                          <td>
                            <input type="number" min="0" class="form-control" value="<?=$res_fetch3['care_QR_fertiliser']?>"   name="care_QR_fertiliser[]" required="">
                          </td>
                           <td>
                            <input type="number" min="0" class="form-control" value="<?=$res_fetch3['care_QR_pesticides']?>"   name="care_QR_pesticides[]" required="">
                          </td>
                           <td>
                            <input type="number" min="0" class="form-control" value="<?=$res_fetch3['care_QR_other']?>"   name="care_QR_other[]" required="">
                          </td>   
                        </tr>
                        <?php }?>
                      </tbody>
                  ...
                  <div id="part4" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                          $get_kictch4="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_hhid`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='0'";
