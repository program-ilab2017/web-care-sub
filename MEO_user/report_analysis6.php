                     ...
                     <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <?php
                              $get_data="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE`care_EV_month`='$months' AND `care_EV_year`='$Year' and `care_EV_them_intervention`='$care_thi_slno' and `care_EV_employee_id`='$employee_id'  and `care_EV_district_name`='$location_user'";
                      ...
                      var data = google.visualization.arrayToDataTable([
                         ...
                         <?php 
                          $get_traget_view="SELECT * FROM `care_master_thematic_interventions_info` WHERE `care_thi_status`='1' order by `care_thi_thematic_name` asc";
                                ...
                                while ($traget_fetch_view=mysqli_fetch_assoc($sql_exe_traget_view)) {
                                   $care_thi_slno=$traget_fetch_view['care_thi_slno'];
                                   $get_data="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE`care_EV_month`='$months' AND `care_EV_year`='$Year' and `care_EV_them_intervention`='$care_thi_slno'  and `care_EV_employee_id`='$employee_id'  and  WHERE `care_EV_district_name`='$location_user'";
                                $sql_get_data=mysqli_query($conn,$get_data);
                                // echo mysqli_num_rows($sql_get_data);
                        ?>
