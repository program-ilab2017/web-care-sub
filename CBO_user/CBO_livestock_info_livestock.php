                ...
                <div class="tab-content">
                  <div id="part1" class="setup-content tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1" >
                      ...
                      <tbody>
                        <?php 
                        $get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1'";
                  ...
                  <div id="part2" class="tab-pane fade">
                     <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           $get_life_stoc="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1'";
                  ...
                  <div id="part3" class="tab-pane fade">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_life_stock3="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1'";
                          ...
                          <td>
                            ...
                            if($fetch_table3['care_LS_CBO_comment_status']=='0'){?>
                             <input  value="<?=web_encryptIt($fetch_table3['care_LS_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$fetch_table3['care_LS_CBO_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($fetch_table3['care_LS_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$fetch_table3['care_LS_CBO_comment_empty']?></textarea>
