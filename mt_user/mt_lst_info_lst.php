                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                          $form_lst1="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina` WHERE `care_MTF_hhid`='$care_hhi' and `care_MTF_month`='$months' and `care_MTF_year`='$year'";
                  ...
                  <div id="part3" class="tab-pane fade">
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php
                          $sql_id_query1="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina` WHERE `care_MTF_hhid`='$care_hhi' and `care_MTF_month`='$months' and `care_MTF_year`='$year' and `care_MTF_vlg_name`='$village'";
                          ...
                          <td>
                            ...
                            if($res12['care_MTF_mt_comment_status']=='0'){?>
                             <input  value="<?=web_encryptIt($res12['care_MTF_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$res12['care_MTF_mt_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($res12['care_MTF_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$res12['care_MTF_mt_comment_empty']?></textarea>
