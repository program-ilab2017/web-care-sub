                         ...
                         <td>
                            ...
                            if($res_fetch4['care_crop_div_mt_id_status']=='0'){?>
                             <input  value="<?=web_encryptIt($res_fetch4['care_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$res_fetch4['care_crop_div_comment_mt']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($res_fetch4['care_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea disabled  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$res_fetch4['care_crop_div_comment_mt']?></textarea>
