                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_detail_fill1="SELECT * FROM `care_master_input_output_tracking_tarina` WHERE `care_TARINA_month`='$months' and `care_TARINA_year`='$year' and `care_TARINA_vlg_name`='$village' and `care_TARINA_hhi`='$care_hhi'";
                 ...
                 <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           $get_detail_fill2="SELECT * FROM `care_master_input_output_tracking_tarina` WHERE `care_TARINA_month`='$months' and `care_TARINA_year`='$year' and `care_TARINA_vlg_name`='$village' and`care_TARINA_hhi`='$care_hhi'";
                          ...
                          <td>
                            ...
                            if($fetch_table2['care_IP_OP_mt_status']=='0'){?>
                             <input  value="<?=web_encryptIt($fetch_table2['care_TARINA_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$fetch_table2['care_IP_OP_mt_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($fetch_table2['care_TARINA_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$fetch_table2['care_IP_OP_mt_comment_empty']?></textarea>
