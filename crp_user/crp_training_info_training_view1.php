            ...
            <div class="row">        
              ...
              <div class="col-xs-12">
                ...
                <div class="tab-content">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                           ...
                           <td>
                            <input type="text" class="form-control" disabled value="<?=$res3['care_EV_training_facilitator']?>" name="Facilitator" required="">
                          </td>
                           <td>
                  ...
                  <ul class="pager">
                    <li class="previous back"><a >Previous</a></li>
                    <li class="next"><?php $name="form9";
echo "<a target='_blank' href='download.php?name=".web_encryptIt($name)."&id=".web_encryptIt($care_EV_slno)."'>Click to download</a>"; //link to download file
?></li>
                 </ul>
                  </div>
