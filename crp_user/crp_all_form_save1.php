...
// 			exit;
		...
		case 'hhi_for_SHG':
			...
			// Array ( [form_type] => X06otqslU9E9QQ1QDb5dv7aXb/Pq8VJiz6X8ymtoinQ= [lat2] => 20.2960587 [lat] => 20.2960587 [long2] => 85.8245398 [long] => 85.8245398 [district] => kalahandi [GP_name] => bankpalas [month] => 05 [Block] => junagarh [Village] => bankpalas [Year] => 2017 [SHG] => Abcd [Topic_Covered] => 2 [event_date] => 10/26/2017 [Duration_session] => YES [Meeting] => 1 [Cash] => 1 [Individual] => 1 [Group] => 1 [Saving] => 1 [Linkage_external_credit] => 1 [Bank_linked] => dcb [linkages_market] => 2 [linkages_technical_support] => 2 [committee_no] => 2 [committee] => SMC [Monthly_status] => 2 [save] => save )

			 $insert_query="INSERT INTO `care_master_mrf_shg_tracking_under_tarina`(
			`care_SHG_slno`,`care_SHG_name`,`care_SHG_total_member`, `care_SHG_LMM_date`, `care_SHG_mem_prsnt_monthly_meeting`,`care_SHG_RMU_meeting_redg`, `care_SHG_RMU_cash_book`,`care_SHG_RMU_ind_passbook`,`care_SHG_RMU_group_passbook`,`care_SHG_RMU_saving_loan_ledger_book`,`care_SHG_ML_linkage_external_credit`,`care_SHG_ML_bank_name`, `care_SHG_ML_no_of_mem_link_market`,`care_SHG_ML_no_of_mem_link_tech_support_provider`,`care_SHG_no_of_mem_link_any_committee`, `care_SHG_committee_name`, `care_SHG_nutrition_discus_SHG_mnthly_meeting`, `care_SHG_employee_id`,`care_SHG_lat_id`, `care_SHG_long_id`, `care_SHG_vlg_name`, `care_SHG_block_name`,`care_SHG_district_name`,`care_SHG_gp_name`,`care_SHG_month`, `care_SHG_year`, `care_SHG_date`,`care_SHG_time`,`care_SHG_status`,`care_SHG_id`,`care_SHG_list_id`) VALUES (NUll,'$SHG','$Topic_Covered','$event_date','$Duration_session','$Meeting','$Cash','$Individual','$Group','$Saving','$Linkage_external_credit','$Bank_linked','$linkages_market','$linkages_technical_support','$committee_no','$committee','$Monthly_status','$employee_id','$lat2','$long2','$Village','$Block','$district','$GP_name','$month','$Year','$date','$time','1','$care_hhi','$care_shg_slno')";
// 
			$sql_exe_insert=mysqli_query($conn,$insert_query);
