              ...
              <div class="col-xs-12">
                ...
                <div class="tab-content">
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                            <select disabled class="form-control" name="Cash" required="">
                             <option value="1"  <?php if($res1['care_SHG_RMU_cash_book']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res1['care_SHG_RMU_cash_book']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td>
                            <select disabled class="form-control" name="Individual" required="">
                            <option value="1"  <?php if($res1['care_SHG_RMU_ind_passbook']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res1['care_SHG_RMU_ind_passbook']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td>
                            <select disabled class="form-control" name="Group" required="">
                             <option value="1"  <?php if($res1['care_SHG_RMU_group_passbook']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res1['care_SHG_RMU_group_passbook']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                           <td>
                   ...
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <!--  <td>
                            <input type="text" class="form-control" name="Others_qnty" required="">
                          </td> -->
                        </tr>
                  ...
                  <ul class="pager">
                   ...
                   <li class="previous back"><a >Previous</a></li>
                    <li class="next"><?php $name="form10";
                      echo "<a target='_blank' href='download.php?name=".web_encryptIt($name)."&id=".web_encryptIt($care_SHG_slno)."'>Click to download</a>"; //link to download file
                      ?></li>
                 </ul>
                  </div>
