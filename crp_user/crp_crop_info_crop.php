                  ...
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <tr>
                          <td>
                             <select id="dates-field2" class="multiselect-ui form-control" multiple="multiple" name="type_crop[]" required="">
                          ...
                          <td><select class="form-control" name="Farmers" id="Farmers" onchange="farm_duct()" required="">
                          ...
                          <td><select class="form-control" name="Continued" id="Continued" onchange="farm_duct_cont()" required="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <input type="number" min="0" class="form-control" value="0" name="Seed_qnty" id="Seed_qnty" required="">
                          </td>
                          <td>
                            <input type="number" min="0" class="form-control" value="0"  name="Fertiliser_qnty" id="Fertiliser_qnty" required="">
                          </td>
                           <td>
                            <input type="number" min="0" class="form-control" value="0"  name="Pesticides_qnty" id="Pesticides_qnty" required="">
                          </td>
                           <td>
                            <input type="number" min="0" class="form-control" value="0"  name="Others_qnty" id="Others_qnty" required="">
                          </td>
...
function farm_duct_cont(){
 ...
 $('#Others_qnty').prop('readonly', true);       
    $('select[name=Seed]').change(function(e){
      if ($('select[name=Seed]').val() == '1'){
    ...
    $('select[name=Fertiliser]').change(function(e){
      if ($('select[name=Fertiliser]').val() == '1'){
     ...
     $('select[name=Pesticides]').change(function(e){
      if ($('select[name=Pesticides]').val() == '1'){
    ...
    // });
     ...
     $('select[name=Others]').change(function(e){
      if ($('select[name=Others]').val() == '2'){
         $('#Others_qnty').prop('readonly', true);
          $('#Others_qnty').val('0');
      }else{
        $('#Others_qnty').prop('readonly', false);
