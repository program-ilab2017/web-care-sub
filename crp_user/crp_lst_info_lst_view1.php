            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                ...
                <div class="tab-content">
                  ...
                  <ul class="pager">
                   <li class="previous back"><a >Previous</a></li>
                   <li class="next"><?php $name="form6";
                      echo "<a target='_blank' href='download.php?name=".web_encryptIt($name)."&id=".web_encryptIt($care_MTF_slno)."'>Click to download</a>"; //link to download file
                      ?></li>
                 </ul>
                  </div>
